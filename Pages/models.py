    ...
    with st.form(key="my_form"):
        ...
        with c2:
            doc = st.text_area(
                ...
                height=510, value = '''Conventional wisdom says house prices double every decade, but in a string of sea- and tree-change hotspots prices have jumped that far in five years or less.
